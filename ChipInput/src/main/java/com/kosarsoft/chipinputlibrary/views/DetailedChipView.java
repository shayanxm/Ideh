...
import com.kosarsoft.chipinputlibrary.util.ColorUtil;
import com.kosarsoft.chipinputlibrary.util.LetterTileProvider;
...
public class DetailedChipView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        mAvatarIconImageView = findViewById(R.id.avatar_icon);
