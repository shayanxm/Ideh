package com.kosarsoft.chipinputlibrary;
...
import com.kosarsoft.chipinputlibrary.adapter.ChipsAdapter;
import com.kosarsoft.chipinputlibrary.model.Chip;
import com.kosarsoft.chipinputlibrary.model.ChipInterface;
import com.kosarsoft.chipinputlibrary.util.ActivityUtil;
import com.kosarsoft.chipinputlibrary.util.MyWindowCallback;
import com.kosarsoft.chipinputlibrary.util.ViewUtil;
import com.kosarsoft.chipinputlibrary.views.ChipsInputEditText;
import com.kosarsoft.chipinputlibrary.views.DetailedChipView;
import com.kosarsoft.chipinputlibrary.views.FilterableListView;
import com.kosarsoft.chipinputlibrary.views.ScrollViewMaxHeight;
...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    private float mTextSize = R.dimen.text_size;
    ...
    private boolean mCustomChip = true;
    ...
    private void init(AttributeSet attrs) {
        ...
        mRecyclerView = findViewById(R.id.chips_recycler);
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mTextSize = a.getDimensionPixelSize(R.styleable.ChipsInput_textSize, 0);
                ...
                mCustomChip = a.getBoolean(R.styleable.ChipsInput_filterable_custom_chip, true);
    ...
    public void onEditorAction(TextView textView, int actionId, KeyEvent keyEvent) {
        if (mChipsListener != null) {
            for (ChipsListener chipsListener : mChipsListenerList) {
                chipsListener.onEditorAction(textView, actionId, keyEvent);
            }
            // show filterable list
            if (mFilterableListView != null) {
                if (textView.getText().length() > 0)
                    mFilterableListView.filterList(textView.getText().toString());
                else
                    mFilterableListView.fadeOut();
            }
        }
