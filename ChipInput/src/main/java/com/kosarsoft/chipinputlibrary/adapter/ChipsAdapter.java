package com.kosarsoft.chipinputlibrary.adapter;
...
import com.kosarsoft.chipinputlibrary.ChipView;
...
public class ChipsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean isCustomChip = true;
    ...
    public ChipsAdapter(Context context, ChipsInput chipsInput, RecyclerView recycler) {
        ...
        mEditText.setTypeface(ResourcesCompat.getFont(context, R.font.iy_regular));

        isCustomChip = mChipsInput.ismCustomChip();
        initEditText();
    }
        ...
        if (isCustomChip) {
            ...
            mEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                ...
                public boolean onEditorAction(TextView textView, int actionId, KeyEvent keyEvent) {
                    mChipsInput.addChip(textView.getText().toString(), "");
                    //mChipsInput.onEditorAction(textView, actionId, keyEvent);
                    return false;
                }
            });
        }
    ...
    public void removeChip() {
        for (int position = 0; position < mChipList.size(); position++) {
            ChipInterface chip = mChipList.get(position);
            // remove contact
            mChipList.remove(position);
            // notify listener
